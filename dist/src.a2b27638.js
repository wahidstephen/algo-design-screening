...
var productIdGenerator = createIdGenerator("product");
var productsWithIds = productsWithoutIds.map(function (product) {
  return _objectSpread({
    // uncomment this!
    id: productIdGenerator()
  }, product);
});
console.log(productsWithIds); // Problem 2
...
var printChildren = function printChildren(node) {// implement me!
};

printChildren(node); // Problem 3

var a = [1, 2, 50, 101]; // const b = a.addToAll(100)
